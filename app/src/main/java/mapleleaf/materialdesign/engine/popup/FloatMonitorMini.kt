...
public class FloatMonitorMini(private val mContext: Context) {
    ...
    fun showPopupWindow(): Boolean {
        ...
        val monitorStorage =
            mContext.getSharedPreferences("float_monitor2_storage", Context.MODE_PRIVATE)
        ...
        params.flags =
            LayoutParams.FLAG_NOT_TOUCH_MODAL or LayoutParams.FLAG_NOT_FOCUSABLE or LayoutParams.FLAG_NOT_TOUCHABLE or LayoutParams.FLAG_FULLSCREEN
    ...
    private fun updateInfo() {
        ...
        myHandler.post {
            ...
            tempText?.text = "$celsiusTemperature°C"
    ...
    private fun setUpView(context: Context): View {
        ...
        currentText = view!!.findViewById(R.id.fw_battery_current)
        tempText = view!!.findViewById(R.id.fw_battery_temp)
