 ...
 */
public abstract class XUIMarqueeFactory<T extends View, E> {
    ...
    private XUIMarqueeView mXUIMarqueeView;

    public XUIMarqueeFactory(Context context) {
        mContext = context;
    }
    ...
    public void setData(List<E> datas) {
        ...
        registerOnItemClick();
        if (mXUIMarqueeView != null) {
            mXUIMarqueeView.setMarqueeFactory(this);
        }
    }
