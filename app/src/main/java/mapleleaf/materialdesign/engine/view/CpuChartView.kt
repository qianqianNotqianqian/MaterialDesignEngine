...
class CpuChartView : View {
    ...
    constructor(context: Context, attrs: AttributeSet) : super(context, attrs) {
        ...
        val total = array.getInteger(R.styleable.RamInfo_all, 1)
    ...
    constructor(context: Context, attrs: AttributeSet, defStyleAttr: Int) : super(
        ...
        @SuppressLint("CustomViewStyleable") val array =
            context.obtainStyledAttributes(attrs, R.styleable.RamInfo)
        val total = array.getInteger(R.styleable.RamInfo_all, 1)
        val fee = array.getInteger(R.styleable.RamInfo_free, 1)
        val feeRatio = (fee * 100.0 / total).toInt()
        ratio = feeRatio
