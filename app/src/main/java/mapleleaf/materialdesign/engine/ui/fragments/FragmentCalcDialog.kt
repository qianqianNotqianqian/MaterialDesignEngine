...
import mapleleaf.materialdesign.engine.databinding.FragmentCalcDialogBinding
import java.math.BigDecimal
import java.text.NumberFormat

class FragmentCalcDialog : Fragment(), CalcDialogCallback {

    private var _binding: FragmentCalcDialogBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentCalcDialogBinding.inflate(inflater, container, false)
        return binding.root
    }
...
//    }
    ...
    private fun updateNumberFormat() {
        nbFmt.maximumIntegerDigits =
            binding.maxIntDigitsInput.text.toString().toIntOrNull().takeIf {
                binding.maxIntDigitsChk.isChecked
            } ?: Integer.MAX_VALUE
        nbFmt.maximumFractionDigits =
            binding.maxFracDigitsInput.text.toString().toIntOrNull().takeIf {
    ...
    private inline fun setupDropdown(
        dropdown: AutoCompleteTextView, @ArrayRes items: Int,
