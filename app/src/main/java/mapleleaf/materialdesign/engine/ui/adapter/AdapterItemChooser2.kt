...
class AdapterItemChooser2(
                ...
                for (i in 0 until count) {
                    ...
                    if (selected.contains(value)) {
                        ...
                        if (valueText.contains(prefixString)) {
                            ...
                            val words =
                                valueText.split(" ".toRegex()).dropLastWhile({ it.isEmpty() })
                                    .toTypedArray()
    ...
    fun updateRow(position: Int, convertView: View) {
        ...
        viewHolder.itemTitle = convertView.findViewById(R.id.componentLabel)
        viewHolder.itemDesc = convertView.findViewById(R.id.ItemDesc)
        viewHolder.imgView = convertView.findViewById(R.id.componentIcon)
