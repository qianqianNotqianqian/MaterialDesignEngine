...
class FragmentMarqueeCommon : UniversalFragmentBase(R.layout.marquee_fragment_tab) {
    ...
    override fun onViewCreated(rootView: View, savedInstanceState: Bundle?) {
        ...
        val sunfushengMarqueeView =
            rootView.findViewById<SunfushengMarqueeView<*>>(R.id.marqueeView)
        val sunfushengMarqueeView1 =
            rootView.findViewById<SunfushengMarqueeView<*>>(R.id.marqueeView1)
        val sunfushengMarqueeView2 =
            rootView.findViewById<SunfushengMarqueeView<*>>(R.id.marqueeView2)
        val sunfushengMarqueeView3 =
            rootView.findViewById<SunfushengMarqueeView<*>>(R.id.marqueeView3)
        val sunfushengMarqueeView4 =
            rootView.findViewById<SunfushengMarqueeView<*>>(R.id.marqueeView4)

        val list = ArrayList<CharSequence>()
        val ss1 = SpannableString("1、MarqueeView开源项目")
        ss1.setSpan(
            ForegroundColorSpan(context?.let { ContextCompat.getColor(it, R.color.red) }!!),
            2,
            13,
        ...
        ss2.setSpan(ForegroundColorSpan(context?.let {
        ...
        sunfushengMarqueeView1.startWithText(
            getString(R.string.marquee_texts),
            R.anim.anim_top_in,
