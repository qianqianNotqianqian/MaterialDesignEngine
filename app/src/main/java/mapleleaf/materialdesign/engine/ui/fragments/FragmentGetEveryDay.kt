...
class FragmentGetEveryDay : UniversalFragmentBase() {
    ...
    override val layoutResId: Int
        get() = R.layout.fragment_every_day
    ...
    override fun onViewCreated(rootView: View, savedInstanceState: Bundle?) {
        ...
        setToolbarTitle(getString(R.string.toolbar_title_fragment_every_day))
        setToolbarSubTitle(getString(R.string.toolbar_subtitle_fragment_every_day))
